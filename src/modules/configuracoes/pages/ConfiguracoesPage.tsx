import { Building2, CreditCard, History, LayoutGrid, Network, ShieldCheck, Users } from 'lucide-react'
...
const sections = [
  ...
  { id: 'plano', title: 'Plano e uso', icon: CreditCard, permission: 'configuracoes.visualizar', description: 'Plano comercial, consumo e limites aplicados à empresa.' },
...
export function ConfiguracoesPage() {
  ...
  return <div className="settings-page">
    <div className="page-heading"><div><span className="eyebrow">ADMINISTRAÇÃO</span><h1>Configurações</h1><p>Gerencie acessos, estrutura organizacional, plano e governança da sua empresa.</p></div><span className="badge green">Administração segura</span></div>
